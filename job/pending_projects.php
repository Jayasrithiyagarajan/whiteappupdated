...
<div class="container-fluid mt-4">
    ...
    <div class="directory-hero">
        <div class="directory-title">
            ...
            <p>Review pending jobs, monitor ageing work, and filter active or expired project assignments.</p>
        </div>
    ...
    <div class="card-box">
        <div class="table-panel-header">
            <div class="table-title">
                ...
                <p>View pending project records, track completion, and open details</p>
            </div>
...
$(document).ready(function() {
    ...
    table = $('#job-table').DataTable({
        ...
        ajax: {
            url: 'fetch_pending_projects.php',
            type: 'POST',
            data: function(d) {
...
function loadFilters(){
    // Reusing fetch_overall_filters.php as the options are likely the same
    // Or we could create fetch_pending_filters.php if options need to be strictly 'pending' related
    // But usually seeing all inspectors/clients is fine. 
    // Let's reuse overall for simplicity unless user requested strict filtering on dropdowns.
    $.ajax({
