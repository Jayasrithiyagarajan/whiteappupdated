...
$where = " WHERE pi.project_status = 'Completed' AND YEAR(pi.creation_date) = YEAR(CURDATE()) ";
$params = [];
$types = "";
...
header('Content-Disposition: attachment; filename="current_year_completed_jobs_'.date('Y-m-d_H-i-s').'.csv"');
