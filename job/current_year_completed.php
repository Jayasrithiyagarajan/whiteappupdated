...
<head>
    <meta charset="UTF-8">
    <title>Current Year Completed Projects</title>
...
<div class="container-fluid mt-4">
    ...
    <div class="directory-hero">
        <div class="directory-title">
            <h2>Current Year Completed Projects</h2>
...
$(document).ready(function() {
    table = $('#job-table').DataTable({
        ...
        ajax: {
            url: 'fetch_current_year_completed.php',
            type: 'POST',
            data: function(d) {
        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    window.location.href = 'export_current_year.php?' + params;
                },
...
function loadStats(){
    $.ajax({
        url: 'fetch_current_year_stats.php',
        type: 'POST',
        dataType: 'json',
        data: {
            filter_inspector: $('#filter-inspector').val(),
