                        ...
                        <form action="update-profile.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- In the general tab section, add this after the role field -->
<!-- In your HTML form section -->
<div class="form-group">
    <label class="font-14 bold mb-2">Profile Photo</label>
    
    <?php 
    if (!empty($user_data['profile_photo'])): 
        $photo_url = '/whiteapp/uploads/profile_photos/' . 
                    strtolower(preg_replace('/[^a-zA-Z0-9]/', '_', $user_data['username'])) . '.png';
        $photo_path = $_SERVER['DOCUMENT_ROOT'] . $photo_url;
    ?>
        <div class="mb-3">
    ...
    <small class="form-text text-muted">Will be saved as <?= htmlspecialchars(strtolower(preg_replace('/[^a-zA-Z0-9]/', '_', $user_data['username']))) ?>.png</small>
</div>
                                </div>
                            </div>
