...
function get_encoded_url($id) {
    $base = "/whiteapp/profileupdate/documentcontroller/document_controller.php";
...
if ($file_uploaded) {
    ...
    // Generate filename as username.png (preserving original case)
    $sanitized_username = preg_replace('/[^a-zA-Z0-9]/', '_', trim($data['username']));
    $file_name = $sanitized_username . '.png'; // Preserve original case
