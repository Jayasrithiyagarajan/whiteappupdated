...
// Function to handle URLs with spaces
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        if (!empty($user_data['profile_photo'])): 
                                            // Generate filename using exact username case
                                            $filename = $user_data['username'] . '.png';
                                            $photo_url = 'https://appcims.com/whiteapp/uploads/profile_photos/' . $filename;
                                            $photo_path = '/home4/appciark/public_html/whiteapp/uploads/profile_photos/' . $filename;
                                        ...
                                        ?>
                                            <div class="mb-3">
                                                <?php if ($file_exists): ?>
                                                    <img src="<?= htmlspecialchars($photo_url) ?>?t=<?= time() ?>" 
                                                         alt="Profile Photo" 
                                                         class="img-thumbnail" 
                                                ...
                                                <?php else: ?>
                                                    <div class="alert alert-warning">
                                                        Profile photo not found (<?= htmlspecialchars($filename) ?>)
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <small class="form-text text-muted">Will be saved as <?= htmlspecialchars($user_data['username'] ?? 'username') ?>.png</small>
                                    </div>
                                </div>
                            </div>
