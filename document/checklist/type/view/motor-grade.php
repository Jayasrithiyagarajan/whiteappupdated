   ...
   <td><img src="../../../code.png" width="80px" height="80px" alt="" /></td>
        ...
        <h4>DS/EN 474-1:2006+A6:2019</h4>
         ...
         <div class="table-responsive">
            ...
            <tr>
                <th style="width: 25%; background-color: #c0d6e8 !important; text-align: left;">CLIENT’S NAME</th>
                <td style="width: 25%;"><strong> <?php echo htmlspecialchars($row['client_name']); ?></strong>
            </td>
                <th style="width: 25%; background-color: #c0d6e8 !important; text-align: left;">INSPECTION DATE</th>
                <td style="width: 25%;">
                <strong> <?php echo htmlspecialchars($row['inspection_date']); ?></strong>
                </td>
            </tr>
            <tr>
                <th style="text-align: left; background-color: #c0d6e8 !important;">LOCATION</th>
                <td><strong> <?php echo htmlspecialchars($row['location']); ?></strong></td>
                <th style="text-align: left; background-color: #c0d6e8 !important;">REPORT NO</th>
                <td><strong> <?php echo htmlspecialchars($row['report_no']); ?></strong></td>
            </tr>
            <tr>
                <th style="text-align: left; background-color: #c0d6e8 !important;">EQUIPMENT NO</th>
                <td><strong> <?php echo htmlspecialchars($row['equipment_no']); ?></strong></td>
                <th style="text-align: left; background-color: #c0d6e8 !important;">STICKER NO.</th>
                <td><strong> <?php echo htmlspecialchars($row['sticker_no']); ?></strong></td>
            </tr>
            <tr>
                <th style="text-align: left; background-color: #c0d6e8 !important;">EQUIPMENT TYPE</th>
                <td><strong> <?php echo htmlspecialchars($row['equipmenttype']); ?></strong></td>
                <th style="text-align: left; background-color: #c0d6e8 !important;">EQUIP. SERIAL NO.</th>
                <td><strong> <?php echo htmlspecialchars($row['crane_serial_no']); ?></strong></td>
            </tr>
            <tr>
                <th style="text-align: left; background-color: #c0d6e8 !important;">MANUFACTURER:</th>
                <td><strong> <?php echo htmlspecialchars($row['manufacturer']); ?></strong></td>
                <th style="text-align: left; background-color: #c0d6e8 !important;">YEAR MODEL:</th>
                <td><strong> <?php echo htmlspecialchars($row['year_model']); ?></strong></td>
            </tr>
            <tr>
                <th style="text-align: left; background-color: #c0d6e8 !important;">EQUIP. MODEL NO.:</th>
                <td><strong> <?php echo htmlspecialchars($row['model_no']); ?></strong></td>
                <th style="text-align: left; background-color: #c0d6e8 !important;">CAPACITY:</th>
