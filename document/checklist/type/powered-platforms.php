...
<td>
    <input type="text" name="checklist_remark[1]" value="<?php echo getRemark(1, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong> Previous Inspection reports are checked	
</strong></td>
				<td style="text-align: center;"><strong> ASME A 120.1
Sec. 3.1.5
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[2]" value="<?php echo getRemark(2, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Warning notice, cautions or restrictions for safe operation and maintenance are clearly displayed and legible (including wind speed)	
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[5]" value="<?php echo getRemark(5, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Manufacturer name, address, serial number and model are clearly marked or tagged	
</strong></td>
				<td style="text-align: center;"><strong>ASME A 120.1 Sec. 3.1.5 </strong></td>
                 <td class="checkbox-cell">
...
<td>
    <input type="text" name="checklist_remark[6]" value="<?php echo getRemark(6, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Safe working load and number of persons are clearly marked on the work platform	
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[7]" value="<?php echo getRemark(7, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Self-Weight of the platform is clearly marked	
</strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.7.2
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[8]" value="<?php echo getRemark(8, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Each suspension jib is marked up with a unique ID number, safe working load and any fitted counterbalance load	
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[11]" value="<?php echo getRemark(11, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>All hooks are fully secured	
 </strong></td>
				<td style="text-align: center;"><strong>
                    ASME A120.1
Sec. 3.4
...
<td>
    <input type="text" name="checklist_remark[12]" value="<?php echo getRemark(12, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Suspension and safety ropes are marked with a unique number and safe working load	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.10
  </strong></td>
...
<!-- <tr>
			...
			<tr>
                ...
                <td><strong>Platform surfaces are slip-resistant materials	
</strong></td>
				<td style="text-align: center;"><strong> ASME A120.1
Sec. 3.7.5.2
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[16]" value="<?php echo getRemark(16, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Platform guardrails are provided and secure	
</strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.7.5
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[17]" value="<?php echo getRemark(17, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Platform guardrails are 42" height (+/- 3")	
</strong></td>
				<td style="text-align: center;"><strong>
                    ASME A120.1
Sec. 3.7.5
...
<td>
    <input type="text" name="checklist_remark[18]" value="<?php echo getRemark(18, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Welded members/joints are free of defects and corrosion	
</strong></td>
				<td style="text-align: center;"><strong>
                    ASME A120.1,
Sec. 3.1.1, 3.1.4
...
<td>
    <input type="text" name="checklist_remark[19]" value="<?php echo getRemark(19, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Maximum operating height is within 130 ft (40m) for jib installation	
</strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.4
</strong></td>
...
<td>
    <input type="text" name="checklist_remark[20]" value="<?php echo getRemark(20, $saved_remarks); ?>">
      ...
      <tr>
                ...
                <td><strong>Each platform occupant has a harness or safety belt (with anchorage for a tail line or a lanyard)
</strong></td>
				<td style="text-align: center;"><strong>	ASME A120.1
Sec. 3.7.5.10
</strong></td>
...
<td>
 ...
 <tr>
                ...
                <td><strong> A tail line or a lanyard has means to be secured to a trolley line or a separate lifeline	
</strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.7.5.10 (a)
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[22]" value="<?php echo getRemark(22, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Each hoist machine/motor is capable of raising and lowering 125% of hoist rated load	
 </strong></td>
				<td style="text-align: center;"><strong> ASME A120.1
Sec. 3.6.1
 </strong></td>
...
<td>
    <input type="text" name="checklist_remark[23]" value="<?php echo getRemark(23, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Electric motors are protected with a current overload device	
</strong></td>
				<td style="text-align: center;"><strong>
                    ASME A120.1
Sec. 3.6.1 (a)
...
<td>
    <input type="text" name="checklist_remark[26]" value="<?php echo getRemark(26, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>All moving parts are guarded	
 </strong></td>
				<td style="text-align: center;"><strong>
                    ASME A120.1
Sec.3.6.5
...
<td>
    <input type="text" name="checklist_remark[27]" value="<?php echo getRemark(27, $saved_remarks); ?>">
			...
			<tr>
                ...
                <td><strong>Gear reduction speed reducers are in compliance with the standards of the American Gear Manufacturers Association	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.3
  </strong></td>
...
<tr>
                ...
                <td><strong>Minimum of two independent hoist brakes are provided	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.8
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[31]" value="<?php echo getRemark(31, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong>Primary brakes are directly connected to the hoist's drive train (belts, shear pins, clutches, roller chains, or friction devices are prohibited)	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.8 (a3)
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[33]" value="<?php echo getRemark(33, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong>Secondary brakes arc directly on the suspension wire rope (or on the drum or drum extension on a winding drum type hoist)	
  </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.8 (b2)
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[34]" value="<?php echo getRemark(34, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong>The secondary brake are not used to stop the hoist except under overspeed or abnormal conditions	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.8 (b3)
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[35]" value="<?php echo getRemark(35, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong>  Lubrication of the hoisting machine and moving parts is adequate	
</strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec.3.6.4
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[36]" value="<?php echo getRemark(36, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> Lubrication points are accessible	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec.3.6.4
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[37]" value="<?php echo getRemark(37, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong>Fillets are provided as points of change in the diameter of hoisting machinery shafts and sheave shafts to prevent excessive stress concentration in the shafts	
  </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.6
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[38]" value="<?php echo getRemark(38, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> Fitted keys, splines, bolts, or machine screws are used in all connections subject to torque	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.6.6
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[39]" value="<?php echo getRemark(39, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> All threaded fasteners have an ant loosening device
 </strong></td>
				<td style="text-align: center;"><strong>	ASME A120.1
Sec. 3.6.6
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[40]" value="<?php echo getRemark(40, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> Suitable runways, ladders, stairs, or platforms are provided for safe access to and egress from all manned scaffold platforms	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.7.5.9
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[41]" value="<?php echo getRemark(41, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> A two-way radio or a two-way telephone system is provided for every manned platform (if applicable)	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec. 3.7.5.6
  </strong></td>
...
<td>
    <input type="text" name="checklist_remark[42]" value="<?php echo getRemark(42, $saved_remarks); ?>">
            ...
            <tr>
                ...
                <td><strong> Wire rope classification is as per manufacturer specifications (check equipment manual)	
 </strong></td>
				<td style="text-align: center;"><strong>ASME A120.1
Sec.3.10.1
  </strong></td>
