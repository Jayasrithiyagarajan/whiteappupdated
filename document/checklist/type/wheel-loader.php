...
<head>
    ...
    <title>INSPECTION CHECKLIST FOR WHEEL LOADER </title>
         ...
         <div class="table-responsive">
          <table class="table table-bordered">
                ...
                <tr>
                    <th>MANUFACTURER:</th>
                    <td>
                        <input type="text" name="manufacturer" value="<?php echo htmlspecialchars($row['manufacturer'] ?? ''); ?>" class="form-control" style="font-weight: bold; border: none; background: transparent;">
                    </td>
                    <th>YEAR MODEL:</th>
                    <td>
                        <input type="text" name="year_model" value="<?php echo htmlspecialchars($row['year_model'] ?? ''); ?>" class="form-control" style="font-weight: bold; border: none; background: transparent;">
                    </td>
                </tr>
                <tr>
                    <th>EQUIP. MODEL NO.:</th>
                    <td>
                        <input type="text" name="model_no" value="<?php echo htmlspecialchars($row['model_no'] ?? ''); ?>" class="form-control" style="font-weight: bold; border: none; background: transparent;">
                    </td>
                    <th>CAPACITY:</th>
                    <td>
