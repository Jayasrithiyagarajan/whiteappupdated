...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['project_no'])) {
    ...
    try {
        ...
        $radius_main_length_3m  = $_POST['radius_main_length_3m'];
        ...
        $notify = $conn->prepare(
            ...
            (project_no, notification_message, status, created_at)
            VALUES (?, ?, 'pending', ?)"
        );
