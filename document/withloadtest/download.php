...
$sql = "SELECT * FROM withload WHERE project_no = ?";
...
<head>
    ...
    <title>LOADTEST Certificate</title>
    <style>
        body {
...
$filename = "Crane_loadtest_certificate_" . $project_no . ".pdf";
$mpdf->Output($filename, 'D'); // Force download with project number
?>