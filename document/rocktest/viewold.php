...
if (!file_exists($technicalManagerSignPath)) {
...
<div class="container">
    ...
    <div class="text-center">
        <p class="certificate-title"><strong> ROCKING TEST (CERTIFICATE OF THOROUGH EXAMINATION)</strong></p>
    </div>
    <table>
        <tr>
            <td colspan="7" style="border-top: none; border-left: none;"> </td>
            <td colspan="7">Job. Ref. No.: <strong><?php echo $jrn; ?></strong></td>
            <td colspan="5">Certificate No.: <strong><?php echo $certificate_no; ?></strong></td>
        </tr>
        <tr>
            <td colspan="3">Report No.: <strong><?php echo $report_no; ?></strong></td>
            <td colspan="4">Date of Report: <strong><?php echo $formatted_date_of_report; ?></strong></td>
            <td colspan="4">Color Code (if required): <em><strong><?php echo $color_code; ?></strong></em></td>
            <td colspan="8">Applicable Standard(s): <strong><?php echo $applicable_standards; ?></strong> </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: center;">
                Name &amp; Address of the employer for whom the examination was made:<br/>
                <strong style="color: #244b90; font-size: 12px; text-transform: uppercase;"><?php echo $customer_name; ?></strong>
            </td>
            <td colspan="7" style="text-align: center;">
                Address of the premises at which the examination was made:<br/>
                <strong style="color: #244b90; font-size: 12px; text-transform: uppercase;"><?php echo $location; ?></strong>
            </td>
            <td colspan="5">
        ...
        <tr>
            <td colspan="19">INSPECTED ITEM TYPE: <strong style="color: #244b90; font-size: 12px; text-transform: uppercase;"><?php echo $inspected_item_type; ?></strong></td>
        </tr>
        ...
        <tr style="height: 200px;">
            <td style="text-align: center;"><strong><?php echo $identification_no; ?></strong></td>
            <td style="text-align: center;"><strong><?php echo $quantity; ?></strong></td>
            <td colspan="3"><strong><?php echo $description; ?></strong></td>
            <td style="text-align: center;"><strong><?php echo $wll_swl; ?></strong></td>
            <td style="text-align: center;"><strong><?php echo $last_examination_date; ?></strong></td>
            <td colspan="2" style="text-align: center;"><strong><?php echo $formatted_this_examination_date; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $formatted_next_examination_date; ?></strong></td>
            <td colspan="2" style="text-align: center;"><strong><?php echo $reason_for_examination; ?></strong></td>
            ...
            <td style="text-align: center; text-transform: uppercase;"><strong><?php echo $safe_to_use; ?></strong></td>
        </tr>
        <tr>
            <td colspan="5" style="text-align: center;">Grease Sample Condition After Analyzing: </td>
            <td colspan="12"> <strong style="text-transform: uppercase;"><?php echo $grease_condition; ?></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" style="text-align: center;"><strong><?php echo $last_aft; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $last_stbd; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $last_forward; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $last_port_side; ?></strong></td>
        </tr>
        <tr>
            <td colspan="5" style="text-align: center;"> Actual Deviation Measured by Dial Gauge Readings </td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $actual_aft; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $actual_stbd; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $actual_forward; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $actual_port_side; ?></strong></td>
        </tr>
        <tr>
            <td colspan="5" style="text-align: center;"> Permitted Limits to be Compared </td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $permitted_aft; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $permitted_stbd; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $permitted_forward; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $permitted_port_side; ?></strong></td>
        </tr>
        <tr>
            <td colspan="5" style="text-align: center;"> Result/OK or Defect of SGOCC <br>
            Required actions for each result is cleared below
            </td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $result_aft; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $result_stbd; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $result_forward; ?></strong></td>
            <td colspan="3" style="text-align: center;"><strong><?php echo $result_port_side; ?></strong></td>
        </tr>
        <tr>
            ...
            <tbody>
                <tr>
                    <td style="text-align: center;">
                        <strong><?php echo $inspector; ?></strong>
                    </td>	
                    <td style="text-align: center;">
                        <strong>
                        LEEA No: <?php echo $leea_number; ?>
                        </strong>
                    </td>	
                ...
                <tr style="height: 200px;">
                    <td colspan="2" style="text-align: center;">
                        <img src="<?php echo $inspectorSignPath; ?>" class="sign" alt="Inspector Signature">
                    </td>
                    <td style="text-align: center;">
                        <img src="<?php echo $technicalManagerSignPath; ?>" alt="Technical Manager Signature" class="sign">
                    </td>
                </tr>
            </tbody>
        </table>
