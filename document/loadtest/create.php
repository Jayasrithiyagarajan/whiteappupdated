...
if (isset($_GET['project_no']) && !empty($_GET['project_no'])) {
    ...
    SELECT 
        ...
        c.checklist_no, c.inspection_date, c.crane_serial_no, c.capacity_swl, c.crane_serial_no, c.capacity_swl, c.model_no, c.manufacturer, c.equipment_no, c.equipmenttype, c.year_model,
...
if ($certResult->num_rows > 0) {
    ...
    preg_match('/CML-(\d+)-\d{4}/', $lastCert, $matches);
    $nextNumber = isset($matches[1]) ? (int)$matches[1] + 1 : 1;
} else {
    $nextNumber = 1;
}

$newCertificateNo = sprintf("CMC-%03d-%s-%s", $nextNumber, $currentYear, $project_no);
    ...
    <div class="container-fluid">
        <div class="glass-header">
            <div class="row align-items-center">
                <div class="col-6">
                    <h1 class="font-20">MOBILE CRANE WITHOUT LOAD TEST</h1>
                </div>
            ...
            <div class="row equal-height">
                ...
                <div class="col-lg-6">
                    <div class="form-element">
                        ...
                        <div class="form-row">
                            <label>Address of Premises</label>
            ...
            <div class="row equal-height">
                <div class="col-lg-6">
                    <div class="form-element">
                        ...
                        <div class="form-row">
                            <label>First examination after installation?</label>
                            <div class="pt-2">
                                <label class="mr-4"><input type="radio" name="first_examination" value="yes"> YES</label>
                                <label><input type="radio" name="first_examination" value="no" checked> NO</label>
                            </div>
                        </div>
                        <div class="form-row">
                            <label>Has equipment been installed correctly?</label>
                            <div class="pt-2">
                                <label class="mr-4"><input type="radio" name="installed_correctly" value="yes"> YES</label>
                                <label><input type="radio" name="installed_correctly" value="no" checked> NO</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-element">
                        ...
                        <div class="form-row d-flex align-items-center">
                            <div class="flex-grow-1"><label class="mb-0">Within an interval of 6 months?</label></div>
                            <div>
                                <label class="mr-3"><input type="radio" name="interval_6_months" value="yes" checked> YES</label>
                                <label><input type="radio" name="interval_6_months" value="no"> NO</label>
                            </div>
                        </div>
                        <div class="form-row d-flex align-items-center">
                            <div class="flex-grow-1"><label class="mb-0">Within an interval of 12 months?</label></div>
                            <div>
                                <label class="mr-3"><input type="radio" name="interval_12_months" value="yes"> YES</label>
                                <label><input type="radio" name="interval_12_months" value="no" checked> NO</label>
                            </div>
                        </div>
                        <div class="form-row d-flex align-items-center">
                            <div class="flex-grow-1"><label class="mb-0">In accordance with examination scheme?</label></div>
                            <div>
                                <label class="mr-3"><input type="radio" name="examination_scheme" value="yes"> YES</label>
                                <label><input type="radio" name="examination_scheme" value="no" checked> NO</label>
                            </div>
                        </div>
                        <div class="form-row d-flex align-items-center">
                            <div class="flex-grow-1"><label class="mb-0">After exceptional circumstances?</label></div>
                            <div>
                                <label class="mr-3"><input type="radio" name="exceptional_circumstances" value="yes"> YES</label>
                                <label><input type="radio" name="exceptional_circumstances" value="no" checked> NO</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-element">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Could become a danger to persons?</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Latest date for next thorough examination:</label>
