...
<div class="main-content">
    <div class="container-fluid">
        <form method="POST" action="save_form.php" id="liftingCertificateForm">
            <input type="hidden" name="certificate_rows_json" id="certificateRowsJson">

            <div class="glass-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="font-20 mb-2">Lifting Gear Certificate Builder</h1>
                        <p class="text-muted mb-0">Build batch certificates quickly using cloning and shared report parameters.</p>
                    </div>
                    <div class="col-md-4 text-right">
                        <div class="mini-stat-grid mt-0">
                            <div class="mini-stat text-left">
                                <div class="mini-stat-label">Rows Ready</div>
                                <div class="mini-stat-value" id="certificateCount">1</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-element">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="date_of_report" class="theme-input-style" value="<?= $today ?>" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="project_no" class="theme-input-style" value="<?= htmlspecialchars($data['project_no']) ?>" readonly>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-element">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="employer_name_address" class="theme-input-style" value="<?= htmlspecialchars($data['customer_name']) ?>" readonly>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="date_of_this_examination" class="theme-input-style" value="<?= $data['date_of_inspection'] ?? '' ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Next Examination Date</label>
                                <input type="date" name="next_examination_date" class="theme-input-style" value="<?= $data['next_inspection_due_date'] ?? '' ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <table class="table table-hover" id="certificateTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="theme-input-style" data-field="certificate_no" readonly>
                                        <div class="cert-preview">Auto-generated</div>
                                    </td>
                                    <td><textarea class="theme-input-style" data-field="identification_no"></textarea></td>
                                    <td><textarea class="theme-input-style" data-field="description"></textarea></td>
            ...
            <div class="sticky-actions">
                <div>
                    <span class="badge badge-info p-2" id="footerCount">1</span> 
                    <span class="ml-2 font-weight-bold">Certificates ready to save</span>
                </div>
                <button type="submit" name="save_data_lifting" class="btn btn-success btn-lg">
                    <i class="fa fa-save mr-2"></i>Save All Certificates
                </button>
            </div>
        </form>
    </div>
...
const form = document.getElementById("liftingCertificateForm");
...
function addRows(count, mode) {
    ...
    if (safeCount === 0) {
        alert(`You can create up to ${maxCertificates} certificates in one batch.`);
        return;
    }
